...
class DiplomaWork < ActiveRecord::Base
	...
	has_many :students
	belongs_to :diploma_supervisor, class_name: "Teacher", 
	foreign_key: "diploma_supervisor_id"
	...
	:unless => lambda { self.reviewer_id.nil? }
	validates :diplomants_number,	:presence => true, 
	:unless => lambda { self.covenanted == true }
